    ...
    public static function GetDataAll($data, $perPage, $request)
    {
        ...
        foreach ($data as $key => $val) {
            ...
            if ($periode != "") {
                ...
                $temp[$key]['pengawas_analisa_target'] = $val->pengawas_analisa_target;
                $temp[$key]['pengawas_inspeksi_target'] = $val->pengawas_inspeksi_target;
                $temp[$key]['pengawas_evaluasi_target'] = $val->pengawas_evaluasi_target;
                $temp[$key]['penyelesaian_identifikasi_target'] = $val->penyelesaian_identifikasi_target;
                $temp[$key]['penyelesaian_realisasi_target'] = $val->penyelesaian_realisasi_target;
                $temp[$key]['penyelesaian_evaluasi_target'] = $val->penyelesaian_evaluasi_target;
                $temp[$key]['bimtek_perizinan_target'] = $val->bimtek_perizinan_target;
                $temp[$key]['bimtek_pengawasan_target'] = $val->bimtek_pengawasan_target;
