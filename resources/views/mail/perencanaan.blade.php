                ...
                <td>
                    <div class="wrap">
                        <div class="wrap-inner" style="background:#fff;border-radius:5px;min-height:300px;padding:20px;border: 1px solid #d3d3d3;">
                            ...
                            <p style="font-size: 14px;text-align:left;margin: 25px 0px 10px;">Kepada Yth, {{ $kepada }} </p>
                            <p style="font-size: 14px;text-align:left;margin: 25px 0px 0px;">  {{ $subject }},</p>
                                <p style="font-size: 14px;text-align:left;margin: 25px 0px 10px;">
                                    {{ $pesan }}
                                </p> 

                            <h3>Link URL Detail Perencanaan </h3>
