...
<!-- Modal -->
<div id="modal-list-setting" class="modal fade" role="dialog">
  <div  class="modal-dialog">
    ...
    <div class="modal-content pull-left full">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Data Setting</h4>
      </div>
            ...
            <div class="pull-left full">
               <div class="pull-left padding-9-0 margin-left-button">
                ...
                <div class="pull-left padding-9-0">
                    <button type="button" id="AddSetting" class="btn btn-primary border-radius-10" >
                     Tambah Data
                    </button> 
                </div>   
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
    ...
    $('#AddSetting').on('click', function() {
       ...
       var row = '';
          row +=`<div class="modal-content pull-left full">`;
              row +=`<div class="modal-header">`;
                ...
                row +=`<h4 class="modal-title">Tambah Setting</h4>`;
              row +=`</div>`;

                
                    row +=`<div class="modal-body">`;

                        row +=`<div id="name-action-alert" class="form-group has-feedback" >`;
                          row +=`<label>Nama</label>`;
                          row +=`<input id="name_action" type="text" class="form-control" name="name" placeholder="Nama" value="">`;
                          row +=`<span id="name-action-messages"></span>`;
                        row +=`</div>`;
                    ...
                    row +=`</div>`;
                     ...
                     row +=`<div class="modal-footer">`;
                        ...
                        row +=`<button id="simpan-action" type="button" class="btn btn-primary" >Simpan</button>`;
                     row +=`</div>`;
       ...
       $('.modal-dialog').html(row);

        // $( ".modal-dialog" ).on( "click", "#simpan-action", (e) => {
    ...
    //       var data = $("#FormSubmitAction").serializeArray();
    //       var form = {
    //           'name':data[0].value};
    ...
    //             {
    //                  $('#name-action-alert').addClass('has-error');
    //                  $('#name-action-messages').addClass('help-block').html('<strong>'+ errors.messages.name +'</strong>');
    //             }else{
    //                 $('#name-action-alert').removeClass('has-error');
    //                 $('#name-action-messages').removeClass('help-block').html('');
    //             }
