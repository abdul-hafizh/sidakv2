...
<div class="content">
	...
	<div class="box box-solid box-primary">
     ...
     @include('template/sidakv2/periode.export')
 ...
 $(document).ready(function() {
    ...
    const total = 0;
     ...
     $("#ExportButton").click(function() {
	     $.ajax({
            url: BASE_URL+ `/api/periode?page=${page}&per_page=all`,
            method: 'GET',
   ...
   function BtnTableDelete(item){
        ...
        if(item.deleted == true)
       {
            ...
            row +=`<div disabled  data-toggle="tooltip" title="Hapus Data"  type="button" class="pointer btn-padding-action pull-left"><i class="fa-icon icon-destroy-disabled" ></i></div>`; 
       }
