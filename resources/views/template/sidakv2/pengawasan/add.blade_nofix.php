                        ...
                        <tr>
                          <td style="padding: 2px;">
                            <div id="nib_0-alert" class="has-feedback">
                              <input type="text" class="form-control" name="nib[]" placeholder="Nomor Induk Berusaha" value="">
                              <span id="nib_0-messages"></span>
                            </div>
                          </td>
                          <td style="padding: 2px;">
                            <div id="tgl_nib_0-alert" class=" has-feedback">
                              <input type="date" class="form-control" name="tgl_nib[]" placeholder="Tanggal NIB">
                        ...
                        <tr>
                          <td style="padding: 2px;">
                            <div id="no_izin_lokasi_0-alert" class=" has-feedback">
                              <input type="text" class="form-control" name="no_izin_lokasi[]" placeholder="Nomor Izin Lokasi" value="">
                              <span id="no_izin_lokasi_0-messages"></span>
                            </div>
                          </td>
                          <td style="padding: 2px;">
                            <div id="tgl_izin_lokasi_0-alert" class=" has-feedback">
                              <input type="date" class="form-control" name="tgl_izin_lokasi[]" placeholder="Tanggal Izin Lokasi">
                        ...
                        <tr>
                          <td style="padding: 2px;">
                            <div id="no_izin_amdal_0-alert" class=" has-feedback">
                              <input type="text" class="form-control" name="no_izin_amdal[]" placeholder="Nomor Izin Amdal" value="">
                              <span id="no_izin_amdal_0-messages"></span>
                            </div>
                          </td>
                          <td style="padding: 2px;">
                            <div id="tgl_izin_amdal_0-alert" class=" has-feedback">
                              <input type="date" class="form-control" name="tgl_izin_amdal[]" placeholder="Tanggal Izin Amdal">
                        ...
                        <tr>
                          <td style="padding: 2px;">
                            <div id="no_izin_lingkungan_0-alert" class=" has-feedback">
                              <input type="text" class="form-control" name="no_izin_lingkungan[]" placeholder="Nomor Izin Lingkungan" value="">
                              <span id="no_izin_lingkungan_0-messages"></span>
                            </div>
                          </td>
                          <td style="padding: 2px;">
                            <div id="tgl_izin_lingkungan_0-alert" class=" has-feedback">
                              <input type="date" class="form-control" name="tgl_izin_lingkungan[]" placeholder="Tanggal Izin Lingkungan">
                        ...
                        <tr>
                          <td style="padding: 2px;">
                            <div id="no_imb_0-alert" class=" has-feedback">
                              <input type="text" class="form-control" name="no_imb[]" placeholder="Nomor IMB" value="">
                              <span id="no_imb_0-messages"></span>
                            </div>
                          </td>
                          <td style="padding: 2px;">
                            <div id="tgl_imb_0-alert" class=" has-feedback">
                              <input type="date" class="form-control" name="tgl_imb[]" placeholder="Tanggal IMB">
                        ...
                        <tr>
                          <td style="padding: 2px;">
                            <div id="total_rencana_inv_0-alert" class=" has-feedback">
                              <input type="number" class="form-control" name="total_rencana_inv[]" placeholder="Total Rencana Inventaris" value="">
                              <span id="total_rencana_inv_0-messages"></span>
                            </div>
                          </td>
                          <td style="padding: 2px;">
                            <div id="total_realisasi_inv_0-alert" class=" has-feedback">
                              <input type="number" class="form-control" name="total_realisasi_inv[]" placeholder="Total Realisasi Inventaris">
                        ...
                        <tr>
                          <td style="padding: 2px;">
                            <div id="rencana_tki_0-alert" class=" has-feedback">
                              <input type="number" class="form-control" name="rencana_tki[]" placeholder="Total Rencana TKI" value="">
                              <span id="rencana_tki_0-messages"></span>
                            </div>
                          </td>
                          <td style="padding: 2px;">
                            <div id="realisasi_tki_0-alert" class=" has-feedback">
                              <input type="number" class="form-control" name="realisasi_tki[]" placeholder="Total Realisasi TKI">
                        ...
                        <tr>
                          <td style="padding: 2px;">
                            <div id="rencana_tka_0-alert" class=" has-feedback">
                              <input type="number" class="form-control" name="rencana_tka[]" placeholder="Total Rencana TKA" value="">
                              <span id="rencana_tka_0-messages"></span>
                            </div>
                          </td>
                          <td style="padding: 2px;">
                            <div id="realisasi_tka_0-alert" class=" has-feedback">
                              <input type="number" class="form-control" name="realisasi_tka[]" placeholder="Total Realisasi TKA">
                    ...
                    <td>
                      ...
                      <table class="table table-hover text-nowrap">
                        <tr>
                          <td style="padding: 2px;">
                            <div id="nib_0-alert" class="has-feedback">
                              <input type="text" class="form-control" name="nib[1]" placeholder="Nomor Induk Berusaha" value="">
                              <span id="nib_0-messages"></span>
                            </div>
                          </td>
                          <td style="padding: 2px;">
                            <div id="tgl_nib_0-alert" class=" has-feedback">
                              <input type="date" class="form-control" name="tgl_nib[1]" placeholder="Tanggal NIB">
                              <span id="tgl_nib_0-messages"></span>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="2" style="padding: 2px;">
                            <div id="nama_perusahaan_0-alert" class=" has-feedback">
                              <input type="text" class="form-control" name="nama_perusahaan[1]" placeholder="Nama Perusahaan" value="">
                              <span id="nama_perusahaan_0-messages"></span>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="2" style="padding: 2px;">
                            <div id="kontak_0-alert" class=" has-feedback">
                              <input type="text" class="form-control" name="kontak[1]" placeholder="Kontak" value="">
                              <span id="kontak_0-messages"></span>
                            </div>
                          </td>
                        </tr>
